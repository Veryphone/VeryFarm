...
public class MachineController : MonoBehaviour
{
    ...
    {
        Transform childObject = transform.FindChild(name);
        if (childObject != null)
    ...
    {
        Transform buttonView = this.transform.FindChild("buttonView");
        Transform cicle = this.transform.FindChild("Cicle");
        Transform productView = this.transform.FindChild("ProductQueue");
        if (buttonView != null)
