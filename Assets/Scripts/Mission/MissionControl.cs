...
public class MissionControl : MonoBehaviour
{
    ...
    {
        loginButton.gameObject.SetActive(true);
        transform.FindChild("Button").FindChild("ButtonShowMessage").gameObject.SetActive(false);
        transform.FindChild("Button").FindChild("ButtonInviteFriend").gameObject.SetActive(false);
        transform.FindChild("Button").FindChild("ButtonHelpFriend").gameObject.SetActive(false);
    }
    ...
    {
        AudioControl.DPlaySound("Click 1");
        transform.FindChild("Dialog").FindChild("DialogEventFriend").GetComponent<DialogEventFriend>().ShowDialog();
    }
